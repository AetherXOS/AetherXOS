...
pub(super) fn log_network_remediation_dashboard() {
    let thresholds = aethercore::modules::drivers::network_slo_thresholds();
    let slo = aethercore::modules::drivers::network_slo_report();
    let remediation_profile = aethercore::modules::drivers::network_remediation_profile();
    let remediation_tuning =
        aethercore::modules::drivers::remediation_tuning_for_profile(remediation_profile);
