pub(crate) fn init_virtualization_bootstrap(enabled: bool) {
    let virt = aethercore::hal::virt::detect_caps();
    ...
    if enabled {
        let enabled_state = aethercore::hal::virt::try_enable_hardware_virtualization();
        #[cfg(feature = "telemetry")]
        aethercore::klog_info!(
        ...
        let launch_ctx_active = aethercore::hal::virt::initialize_launch_context();
        #[cfg(feature = "telemetry")]
        aethercore::klog_info!(
        ...
        #[cfg(feature = "telemetry")]
        aethercore::klog_info!("Virtualization enable path disabled by config");
    }

    let virt_status = aethercore::hal::virt::status();
    #[cfg(feature = "telemetry")]
    aethercore::klog_info!(
