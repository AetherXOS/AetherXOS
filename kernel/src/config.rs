...
static EXEC_ELF_REQUIRE_ABSOLUTE_INTERP_PATH_OVERRIDE: AtomicUsize = AtomicUsize::new(0);
static EXEC_ELF_ENFORCE_INTERP_PATH_SANITIZATION_OVERRIDE: AtomicUsize = AtomicUsize::new(0);
static EXEC_ELF_ENFORCE_SYSTEM_LOADER_PATHS_OVERRIDE: AtomicUsize = AtomicUsize::new(0);
static EXEC_ELF_ENFORCE_SEGMENT_CONGRUENCE_OVERRIDE: AtomicUsize = AtomicUsize::new(0);
static EXEC_AUXV_ENFORCE_HANDOFF_CONTRACT_OVERRIDE: AtomicUsize = AtomicUsize::new(0);
static EXEC_AUXV_REQUIRE_PHDR_TRIPLET_OVERRIDE: AtomicUsize = AtomicUsize::new(0);
static USERSPACE_ABI_REQUIRE_GLIBC_VFS_SURFACE_OVERRIDE: AtomicUsize = AtomicUsize::new(0);
static USERSPACE_ABI_REQUIRE_GLIBC_NETWORK_SURFACE_OVERRIDE: AtomicUsize = AtomicUsize::new(0);
static USERSPACE_ABI_REQUIRE_GLIBC_IPC_SURFACE_OVERRIDE: AtomicUsize = AtomicUsize::new(0);
static USERSPACE_ABI_LIBC_SURFACE_WEIGHT_PERCENT_OVERRIDE: AtomicUsize = AtomicUsize::new(0);
