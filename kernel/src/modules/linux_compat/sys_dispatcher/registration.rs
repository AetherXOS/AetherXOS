...
use crate::modules::linux_compat::fs::attr::*;
use crate::modules::linux_compat::mem::mman::*;
use crate::modules::linux_compat::{Fd, UserPtr};
...
pub fn populate_table() {
    ...
    register_syscall(linux_nr::PIPE2, |f, _| sys_linux_pipe2(uptr!(f.a1), f.a2 as usize));
    ...
    register_syscall(linux_nr::GETPID, |_, _| crate::modules::linux_compat::cred::sys_linux_getpid());
    register_syscall(linux_nr::BRK, |f, _| crate::modules::linux_compat::mem::brk::sys_linux_brk(f.a1 as usize));
    register_syscall(linux_nr::MMAP, |f, _| sys_linux_mmap(uptr!(f.a1), f.a2 as usize, f.a3 as usize, f.a4 as usize, fd!(f.a5), f.a6 as usize));
    register_syscall(linux_nr::MUNMAP, |f, _| sys_linux_munmap(uptr!(f.a1), f.a2));
