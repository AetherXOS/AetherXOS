...
pub fn render_compat_config_key(key: &str) -> Result<String, &'static str> {
    ...
    match normalized.as_str() {
        ...
        "runtime_core_entrypoints" => Ok(
            "_start,__aethercore_crt0_start,__aethercore_auxv_init,__aethercore_env_init,__aethercore_syscall_init\n"
                .into(),
        ),
        ...
        "startup_runtime_contract_env_keys" => Ok(
            "AETHERCORE_RUNTIME_ENTRY,AETHERCORE_RUNTIME_FINI_ENTRY,AETHERCORE_IMAGE_ENTRY,AETHERCORE_IMAGE_BASE,AETHERCORE_PHDR,AETHERCORE_VDSO_BASE,AETHERCORE_VVAR_BASE,AETHERCORE_INIT_HOOKS,AETHERCORE_FINI_HOOKS,AETHERCORE_EXEC_PATH,AETHERCORE_SECURITY_PROFILE,AETHERCORE_SYSCALL_ABI_VERSION,AETHERCORE_SYSCALL_PLATFORM,AETHERCORE_RUNTIME_VDSO,AETHERCORE_RUNTIME_TLS,AETHERCORE_RUNTIME_SIGNAL_ABI,AETHERCORE_RUNTIME_INIT_HOOKS,AETHERCORE_RUNTIME_FINI_HOOKS,AETHERCORE_RUNTIME_FINI_TRAMPOLINE,AETHERCORE_RUNTIME_MULTI_USER,AETHERCORE_RUNTIME_CAPABILITY_MODEL\n"
                .into(),
        ),
        "startup_syscall_env_keys" => Ok(
            "AETHERCORE_SYSCALL_READ,AETHERCORE_SYSCALL_WRITE,AETHERCORE_SYSCALL_OPENAT,AETHERCORE_SYSCALL_CLOSE,AETHERCORE_SYSCALL_EXECVE,AETHERCORE_SYSCALL_EXIT,AETHERCORE_SYSCALL_ARCH_PRCTL,AETHERCORE_SYSCALL_GETPID,AETHERCORE_SYSCALL_GETPPID,AETHERCORE_SYSCALL_GETUID,AETHERCORE_SYSCALL_GETEUID,AETHERCORE_SYSCALL_GETGID,AETHERCORE_SYSCALL_GETEGID,AETHERCORE_SYSCALL_CLOCK_GETTIME,AETHERCORE_SYSCALL_GETTIMEOFDAY,AETHERCORE_SYSCALL_TIME,AETHERCORE_SYSCALL_FUTEX,AETHERCORE_SYSCALL_MMAP,AETHERCORE_SYSCALL_MUNMAP,AETHERCORE_SYSCALL_RT_SIGACTION,AETHERCORE_SYSCALL_RT_SIGRETURN\n"
                .into(),
        ),
        "startup_auxv_env_keys" => Ok(
            "AETHERCORE_AUXV_AT_BASE,AETHERCORE_AUXV_AT_PHDR,AETHERCORE_AUXV_AT_PHENT,AETHERCORE_AUXV_AT_PHNUM,AETHERCORE_AUXV_AT_PAGESZ,AETHERCORE_AUXV_AT_ENTRY,AETHERCORE_AUXV_AT_UID,AETHERCORE_AUXV_AT_EUID,AETHERCORE_AUXV_AT_GID,AETHERCORE_AUXV_AT_EGID,AETHERCORE_AUXV_AT_PLATFORM,AETHERCORE_AUXV_AT_HWCAP,AETHERCORE_AUXV_AT_CLKTCK,AETHERCORE_AUXV_AT_SECURE,AETHERCORE_AUXV_AT_RANDOM,AETHERCORE_AUXV_AT_EXECFN,AETHERCORE_AUXV_AT_SYSINFO_EHDR\n"
                .into(),
        ),
        "auxv_at_base" => Ok("7\n".into()),
        "auxv_at_phdr" => Ok("3\n".into()),
