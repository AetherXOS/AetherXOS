...
pub fn kernel_shim_path() -> PathBuf {
    LAYOUT.root.join("kernel/syscalls/linux_shim")
}
...
pub mod repo_paths {
    ...
    pub const UBUNTU_USERSPACE_SMOKE_JSON: &str =
        "artifacts/userspace_apps/ubuntu_smoke_summary.json";
    pub const UBUNTU_USERSPACE_SMOKE_JUNIT_XML: &str =
        "artifacts/userspace_apps/ubuntu_smoke_junit.xml";
