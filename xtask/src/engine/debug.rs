...
impl Task for DebugBridgeTask {
    fn name(&self) -> String { "Interactive Debug Bridge".to_string() }
    fn description(&self) -> String { "Launches QEMU with GDB server and prepares debugging symbols".to_string() }
