...
impl TraceCategory {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            TraceCategory::Launch => "launch",
            TraceCategory::Loader => "loader",
            TraceCategory::Task => "task",
    ...
    pub const fn from_u8(value: u8) -> Option<Self> {
        match value {
            x if x == TraceCategory::Core as u8 => Some(TraceCategory::Core),
            x if x == TraceCategory::Launch as u8 => Some(TraceCategory::Launch),
            x if x == TraceCategory::Loader as u8 => Some(TraceCategory::Loader),
            x if x == TraceCategory::Task as u8 => Some(TraceCategory::Task),
            x if x == TraceCategory::Memory as u8 => Some(TraceCategory::Memory),
            x if x == TraceCategory::Scheduler as u8 => Some(TraceCategory::Scheduler),
            x if x == TraceCategory::Fault as u8 => Some(TraceCategory::Fault),
            _ => None,
        }
    }
}
