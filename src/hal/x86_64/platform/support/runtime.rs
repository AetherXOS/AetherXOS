...
pub(super) fn current_runtime_support() -> RuntimeSupportSnapshot {
    let plan = crate::hal::x86_64::virt::guest_backend_runtime_plan();
    let dispatch = crate::hal::x86_64::virt::guest_runtime_dispatch_hint();
    let schedule = crate::hal::x86_64::virt::guest_runtime_scheduling_profile();
